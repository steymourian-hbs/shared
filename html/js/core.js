...
var Core = {
    ...
    add_link_class: function(a) {
        ...
        if (a.href && !/mailto/.test(a.href)) {
            ...
            if (/video2.harvard.edu/.test(a.href)) {$a.removeClass("ext");}
            if (/hbsp.harvard.edu/.test(a.href)) {$a.removeClass("ext");}
            if (/hbr.org/.test(a.href)) {$a.removeClass("ext");}
            if (/harvardbusiness.org/.test(a.href)) {$a.removeClass("ext");}
            if ( /.pdf$/.test(a.href)) {$a.addClass('pdf')}
        }
        ...
        // if there are any images inside the a tag
        if ($a.children("img").size() > 0) {
            $a.removeClass('ext');
        }
    ...
    std_link: function(a,options) {    
        Core.add_link_class(a);
        $a = $(a);
        if (options.new_window_ext && $a.hasClass("ext")) {
        ...
        if ($a.hasClass('ext') && options.icons) {
           $a.append('<img src="'+options.icons+'icon.ext.gif" class="ext-icon icon" alt="offsite" />');
        }
        if ($a.hasClass('pdf') && options.icons) {
           $a.prepend('<img src="'+options.icons+'icon.pdf.gif" class="pdf-icon icon" alt="offsite" />');
        }
